...
public class CurrencyControllerTest extends BaseControllerTest {
    ...
    public void saveWithDuplicate() throws Exception {
        expectDuplicateFailJsonRequest(mvc.perform(postJsonRequest("/currency/save", new CurrencyDAO("新台幣"))));
    }
    ...
    public void deleteByIdWithNotFoundId() throws Exception {
        expectDatabaseFailJsonRequest(mvc.perform(delete("/currency/delete/{id}", 1L)));
    }
    ...
    public void updateWithDuplicateName() throws Exception {
        ...
        expectDuplicateFailJsonRequest(mvc.perform(patchJsonRequest("/currency/update", entity)));
    }
    ...
    public void findByIdWithNotFound() throws Exception {
        expectDatabaseFailJsonRequest(mvc.perform(get("/currency/find/{id}", 1L)));
    }
